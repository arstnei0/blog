...
<img class="desktop-only" src="/js-framework-comparison-1.png" width="700" />
<img class="desktop-only" src="/js-framework-comparison-2.png" width="700" />
<img class="desktop-only" src="/js-framework-comparison-3.png" width="700" />
<div class="mobile-only">
    <p>图片在移动端显示效果不好，请看</p>
    <a href="/js-framework-comparison-1.png">图一</a>
    <a href="/js-framework-comparison-2.png">图二</a>
    <a href="/js-framework-comparison-3.png">图三</a>
</div>
