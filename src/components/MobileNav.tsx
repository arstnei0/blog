...
const MobileNav: Component<{}> = (props) => {
	...
	const toggle = () => {
		...
		if (opened()) {
			document.body.classList.replace('menu-closed', 'menu-opened')
		} else {
			document.body.classList.replace('menu-opened', 'menu-closed')
		}
	}
		...
		<>
            ...
            <Show when={opened()}>
			    <div class="fixed" id="mobile-menu">
                    ...
                    <a classList={ page === '/projects' ? { selected: true, 'nav-item': true } : { 'nav-item': true } } href="/projects">Projects</a>
                    <a classList={ page === '/blog' ? { selected: true, 'nav-item': true } : { 'nav-item': true } } href="/blog">Blog</a>
