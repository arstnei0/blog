...
const Nav: Component<{
    ...
    return <>
        <label for="check" class="bar" id="toggleMenu">
            <input id="check" type="checkbox" onChange={() => setOpen(open => !open)} checked={open()}></input>
        ...
        <nav id="rightHeader" classList={{ [!open() ? 'nod' : 'block']: true }}>
